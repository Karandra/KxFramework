...
namespace Kx::EventSystem
{
	class KX_API IEvtHandler
	{
		...
		public:
			IEvtHandler(wxEvtHandler& evtHandler)
		...
		public:
			...
			{
				return const_cast<IEvtHandler*>(this)->GetTargetHandler();
			}
		...
		public:
			...
			{
				return m_EvtHandler.Bind(eventTag, method, static_cast<TClass*>(&m_EvtHandler));
			}
