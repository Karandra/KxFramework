...
#define KxEVENT_DECLARE_GLOBAL(type, name)						extern const KX_API KxEventTag<type> KxEVT_##name
#define KxEVENT_DEFINE_GLOBAL(type, name)						const KxEventTag<type> KxEVT_##name = KxEvent::NewEventID()
#define KxEVENT_DEFINE_GLOBAL_AS(type, name, other)				const KxEventTag<type> KxEVT_##name = static_cast<KxEventID>(other)

// For local scope (namespace, function, etc)
#define KxEVENT_DECLARE_LOCAL(type, name)						extern KX_API const KxEventTag<type> Evt##name
#define KxEVENT_DEFINE_LOCAL(type, name)						const KxEventTag<type> Evt##name = KxEvent::NewEventID()
#define KxEVENT_DEFINE_LOCAL_AS(type, name, other)				const KxEventTag<type> Evt##name = static_cast<KxEventID>(other)
...
#define KxEVENT_DECLARE_ALIAS_TO_MEMBER(type, name)				inline const KxEventTag<type> Evt##name = type::Evt##name
#define KxEVENT_DECLARE_ALIAS_TO_MEMBER_AS(type, name, other)	inline const KxEventTag<type> Evt##name = type::Evt##other
