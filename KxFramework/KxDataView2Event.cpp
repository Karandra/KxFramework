...
namespace KxDataView2
{
	...
	KxEVENT_DEFINE_LOCAL(COLUMN_HEADER_MENU_ITEM, Event);
	KxEVENT_DEFINE_LOCAL(COLUMN_HEADER_SEPARATOR_DCLICK, Event);
	KxEVENT_DEFINE_LOCAL(COLUMN_HEADER_WIDTH_FIT, Event);
