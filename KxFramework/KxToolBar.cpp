...
wxDEFINE_EVENT(KxEVT_TOOLBAR, wxCommandEvent);
wxDEFINE_EVENT(KxEVT_TOOLBAR_RIGHTCLICK, wxCommandEvent);
wxDEFINE_EVENT(KxEVT_TOOLBAR_DROPDOWN, wxCommandEvent);
wxDEFINE_EVENT(KxEVT_TOOLBAR_ENTER, wxCommandEvent);
wxDEFINE_EVENT(KxEVT_TOOLBAR_LEAVE, wxCommandEvent);
