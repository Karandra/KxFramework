...
KxEVENT_DEFINE_GLOBAL(wxCommandEvent, TOOLBAR);
KxEVENT_DEFINE_GLOBAL(wxCommandEvent, TOOLBAR_RIGHTCLICK);
KxEVENT_DEFINE_GLOBAL(wxCommandEvent, TOOLBAR_DROPDOWN);
KxEVENT_DEFINE_GLOBAL(wxCommandEvent, TOOLBAR_ENTER);
KxEVENT_DEFINE_GLOBAL(wxCommandEvent, TOOLBAR_LEAVE);
