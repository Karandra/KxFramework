...
//////////////////////////////////////////////////////////////////////////
KxEVENT_DECLARE_GLOBAL(KxFileOperationEvent, FILEOP_COPY);
KxEVENT_DECLARE_GLOBAL(KxFileOperationEvent, FILEOP_MOVE);
KxEVENT_DECLARE_GLOBAL(KxFileOperationEvent, FILEOP_REMOVE);
KxEVENT_DECLARE_GLOBAL(KxFileOperationEvent, FILEOP_COPY_FOLDER);
KxEVENT_DECLARE_GLOBAL(KxFileOperationEvent, FILEOP_MOVE_FOLDER);
KxEVENT_DECLARE_GLOBAL(KxFileOperationEvent, FILEOP_REMOVE_FOLDER);
KxEVENT_DECLARE_GLOBAL(KxFileOperationEvent, FILEOP_SEARCH);
KxEVENT_DECLARE_GLOBAL(KxFileOperationEvent, FILEOP_RENAME);
