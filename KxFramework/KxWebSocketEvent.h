...
KxEVENT_DECLARE_GLOBAL(KxWebSocketEvent, WEBSOCKET_OPEN);
KxEVENT_DECLARE_GLOBAL(KxWebSocketEvent, WEBSOCKET_FAIL);
KxEVENT_DECLARE_GLOBAL(KxWebSocketEvent, WEBSOCKET_CLOSE);
KxEVENT_DECLARE_GLOBAL(KxWebSocketEvent, WEBSOCKET_MESSAGE);
KxEVENT_DECLARE_GLOBAL(KxWebSocketEvent, WEBSOCKET_CONNECTING);
