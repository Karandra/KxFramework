...
KxEVENT_DECLARE_GLOBAL(wxCommandEvent, TOOLBAR);
KxEVENT_DECLARE_GLOBAL(wxCommandEvent, TOOLBAR_RIGHTCLICK);
KxEVENT_DECLARE_GLOBAL(wxCommandEvent, TOOLBAR_DROPDOWN);
KxEVENT_DECLARE_GLOBAL(wxCommandEvent, TOOLBAR_ENTER);
KxEVENT_DECLARE_GLOBAL(wxCommandEvent, TOOLBAR_LEAVE);
