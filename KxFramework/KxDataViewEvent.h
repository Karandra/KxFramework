...
//////////////////////////////////////////////////////////////////////////
KxEVENT_DECLARE_GLOBAL(DATAVIEW_ITEM_SELECTED, KxDataViewEvent);
KxEVENT_DECLARE_GLOBAL(DATAVIEW_ITEM_HOVERED, KxDataViewEvent);
KxEVENT_DECLARE_GLOBAL(DATAVIEW_ITEM_ACTIVATED, KxDataViewEvent);
KxEVENT_DECLARE_GLOBAL(DATAVIEW_ITEM_COLLAPSED, KxDataViewEvent);
KxEVENT_DECLARE_GLOBAL(DATAVIEW_ITEM_EXPANDED, KxDataViewEvent);
KxEVENT_DECLARE_GLOBAL(DATAVIEW_ITEM_COLLAPSING, KxDataViewEvent);
KxEVENT_DECLARE_GLOBAL(DATAVIEW_ITEM_EXPANDING, KxDataViewEvent);
KxEVENT_DECLARE_GLOBAL(DATAVIEW_ITEM_CONTEXT_MENU, KxDataViewEvent);
KxEVENT_DECLARE_GLOBAL(DATAVIEW_ITEM_VALUE_CHANGED, KxDataViewEvent);

KxEVENT_DECLARE_GLOBAL(DATAVIEW_ITEM_EDIT_ATTACH, KxDataViewEvent);
KxEVENT_DECLARE_GLOBAL(DATAVIEW_ITEM_EDIT_DETACH, KxDataViewEvent);
KxEVENT_DECLARE_GLOBAL(DATAVIEW_ITEM_EDIT_STARTING, KxDataViewEvent);
KxEVENT_DECLARE_GLOBAL(DATAVIEW_ITEM_EDIT_STARTED, KxDataViewEvent);
KxEVENT_DECLARE_GLOBAL(DATAVIEW_ITEM_EDIT_DONE, KxDataViewEvent);

KxEVENT_DECLARE_GLOBAL(DATAVIEW_COLUMN_HEADER_CLICK, KxDataViewEvent);
KxEVENT_DECLARE_GLOBAL(DATAVIEW_COLUMN_HEADER_RIGHT_CLICK, KxDataViewEvent);
KxEVENT_DECLARE_GLOBAL(DATAVIEW_COLUMN_SORTED, KxDataViewEvent);
KxEVENT_DECLARE_GLOBAL(DATAVIEW_COLUMN_REORDERED, KxDataViewEvent);

KxEVENT_DECLARE_GLOBAL(DATAVIEW_CACHE_HINT, KxDataViewEvent);

KxEVENT_DECLARE_GLOBAL(DATAVIEW_ITEM_DRAG, KxDataViewEventDND);
KxEVENT_DECLARE_GLOBAL(DATAVIEW_ITEM_DROP_POSSIBLE, KxDataViewEventDND);
KxEVENT_DECLARE_GLOBAL(DATAVIEW_ITEM_DROP, KxDataViewEventDND);
