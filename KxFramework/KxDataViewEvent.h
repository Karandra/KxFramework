...
class KxDataViewListModel;

class KxDataViewEvent: public wxNotifyEvent
{
	private:
...
//////////////////////////////////////////////////////////////////////////
class KxDataViewEventDND: public KxDataViewEvent
{
	private:
...
//////////////////////////////////////////////////////////////////////////
wxDECLARE_EVENT(KxEVT_DATAVIEW_ITEM_SELECTED, KxDataViewEvent);
wxDECLARE_EVENT(KxEVT_DATAVIEW_ITEM_HOVERED, KxDataViewEvent);
wxDECLARE_EVENT(KxEVT_DATAVIEW_ITEM_ACTIVATED, KxDataViewEvent);
wxDECLARE_EVENT(KxEVT_DATAVIEW_ITEM_COLLAPSED, KxDataViewEvent);
wxDECLARE_EVENT(KxEVT_DATAVIEW_ITEM_EXPANDED, KxDataViewEvent);
wxDECLARE_EVENT(KxEVT_DATAVIEW_ITEM_COLLAPSING, KxDataViewEvent);
wxDECLARE_EVENT(KxEVT_DATAVIEW_ITEM_EXPANDING, KxDataViewEvent);
wxDECLARE_EVENT(KxEVT_DATAVIEW_ITEM_CONTEXT_MENU, KxDataViewEvent);
wxDECLARE_EVENT(KxEVT_DATAVIEW_ITEM_VALUE_CHANGED, KxDataViewEvent);

wxDECLARE_EVENT(KxEVT_DATAVIEW_ITEM_EDIT_ATTACH, KxDataViewEvent);
wxDECLARE_EVENT(KxEVT_DATAVIEW_ITEM_EDIT_DETACH, KxDataViewEvent);
wxDECLARE_EVENT(KxEVT_DATAVIEW_ITEM_EDIT_STARTING, KxDataViewEvent);
wxDECLARE_EVENT(KxEVT_DATAVIEW_ITEM_EDIT_STARTED, KxDataViewEvent);
wxDECLARE_EVENT(KxEVT_DATAVIEW_ITEM_EDIT_DONE, KxDataViewEvent);

wxDECLARE_EVENT(KxEVT_DATAVIEW_COLUMN_HEADER_CLICK, KxDataViewEvent);
wxDECLARE_EVENT(KxEVT_DATAVIEW_COLUMN_HEADER_RIGHT_CLICK, KxDataViewEvent);
wxDECLARE_EVENT(KxEVT_DATAVIEW_COLUMN_SORTED, KxDataViewEvent);
wxDECLARE_EVENT(KxEVT_DATAVIEW_COLUMN_REORDERED, KxDataViewEvent);

wxDECLARE_EVENT(KxEVT_DATAVIEW_CACHE_HINT, KxDataViewEvent);

wxDECLARE_EVENT(KxEVT_DATAVIEW_ITEM_DRAG, KxDataViewEventDND);
wxDECLARE_EVENT(KxEVT_DATAVIEW_ITEM_DROP_POSSIBLE, KxDataViewEventDND);
wxDECLARE_EVENT(KxEVT_DATAVIEW_ITEM_DROP, KxDataViewEventDND);
