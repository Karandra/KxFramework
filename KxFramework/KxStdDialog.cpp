...
wxDEFINE_EVENT(KxEVT_STDDIALOG_BUTTON, wxNotifyEvent);
wxDEFINE_EVENT(KxEVT_STDDIALOG_NAVIGATE, wxNotifyEvent);
wxDEFINE_EVENT(KxEVT_STDDIALOG_NAVIGATING, wxNotifyEvent);
wxDEFINE_EVENT(KxEVT_STDDIALOG_OVERWRITE, wxNotifyEvent);
wxDEFINE_EVENT(KxEVT_STDDIALOG_SELECT, wxNotifyEvent);
wxDEFINE_EVENT(KxEVT_STDDIALOG_TYPE_CHANGED, wxNotifyEvent);
