...
namespace KxDataView2
{
	...
	HeaderCtrl2::EventResult HeaderCtrl2::SendCtrlEvent(Event& event, wxEventType type, Column* column, std::optional<wxRect> rect)
	{
	...
	bool HeaderCtrl2::Create(View* parent, long style)
	{
		...
		if (wxControl::Create(parent, KxID_NONE, wxDefaultPosition, wxDefaultSize, style))
		{
			EnableSystemTheme();
