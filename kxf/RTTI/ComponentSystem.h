...
namespace kxf::RTTI
{
	class KX_API IComponent: public Interface<IComponent>
	{
		...
		KxDecalreIID(IComponent, {0x8ac99b20, 0xc73f, 0x4707, {0x98, 0x9e, 0xbb, 0x11, 0xfd, 0x48, 0x3f, 0x9d}});
	...
	{
		KxDecalreIID(IComponentContainer, {0xd82d81d0, 0xf63e, 0x481d, {0x92, 0xee, 0x16, 0xd5, 0x34, 0xf1, 0x58, 0x77}});
