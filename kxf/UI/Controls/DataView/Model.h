...
namespace kxf::UI::DataView
{
	...
	{
		KxDeclareIID(Model, {0xf9971234, 0xa17b, 0x42bf, {0x84, 0x9a, 0xa9, 0x13, 0xf1, 0x20, 0xc9, 0x35}});
...
namespace kxf::UI::DataView
{
	...
	{
		KxDeclareIID(ListModel, {0x98e3d563, 0x5ddf, 0x458c, {0xa8, 0x8, 0x70, 0x55, 0xb0, 0x49, 0x2e, 0xb3}});
...
namespace kxf::UI::DataView
{
	...
	{
		KxDeclareIID(VirtualListModel, {0x90797bbe, 0xe618, 0x4351, {0xa2, 0x86, 0x1, 0xea, 0xe8, 0x4c, 0x73, 0x48}});
